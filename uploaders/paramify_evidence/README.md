...
The uploader authenticates with `PARAMIFY_API_TOKEN`. To create one:
...
2. Click **+ API Key** and configure it:
   - **Name:** `PARAMIFY_API_TOKEN` (or any recognizable label)
...
```bash
export PARAMIFY_API_TOKEN=<paste key here>
