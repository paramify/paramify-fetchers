#!/usr/bin/env python3
"""
Wiz Container Vulnerabilities

Open Wiz vulnerability findings on container assets, summarized by severity, CISA
...
logger = logging.getLogger("wiz_container_vulnerabilities")


def body(client: WizClient) -> Dict[str, Any]:
    result = collect_bucket(client, "container")
    ...
    return evidence(
        ...
        empty_message="No open container vulnerability findings. Check wiz_scan_coverage before "
...
if __name__ == "__main__":
    sys.exit(run_fetcher(collect, "wiz_container_vulnerabilities.json", logger))
